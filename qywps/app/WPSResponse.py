...
class WPSResponse():
    ...
    def __init__(self, process, wps_request, uuid, status_url=None):
        ...
        :param qywps.app.Process.Process process:
        :param qywps.app.WPSRequest.WPSRequest wps_request:
    ...
    def update_status(self, message=None, status_percentage=None, status=None):
        ...
        :param qywps.app.WPSResponse.STATUS status: process status - user should usually
