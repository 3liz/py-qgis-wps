...
from qywps.validator.allowed_value import RANGECLOSURETYPE
...
class AllowedValue(AnyValue):
    ...
    :param qywps.validator.allowed_value.ALLOWEDVALUETYPE allowed_type: VALUE or RANGE
    ...
    :param qywps.input.literaltypes.RANGECLOSURETYPE range_closure:
    """
...
def make_allowedvalues(allowed_values):
    ...
    :return: list of qywps.inout.literaltypes.AllowedValue
    """
