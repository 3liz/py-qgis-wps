...
from qywps import configuration, E, OWS, WPS, OGCTYPE, NAMESPACES
from qywps.inout import basic
from copy import deepcopy
from qywps.validator.mode import MODE
from qywps.inout.literaltypes import AnyValue
...
class ComplexInput(basic.ComplexInput):
    ...
    :param qywps.inout.formats.Format supported_formats: List of supported formats
    :param qywps.inout.formats.Format data_format: default data format
    ...
    def calculate_max_input_size(self):
        ...
        """
        max_size = configuration.get_config('server').get('maxsingleinputsize')
...
class LiteralInput(basic.LiteralInput):
    ...
    :param int max_occurs: maximum occurence
    :param qywps.validator.mode.MODE mode: validation mode (none to strict)
    :param qywps.inout.literaltypes.AnyValue allowed_values: or :py:class:`qywps.inout.literaltypes.AllowedValue` object
    :param metadata: List of metadata advertised by this process. They
                     should be :class:`qywps.app.Common.Metadata` objects.
    """
