...
def _get_mimetypes():
    ...
    """
    mimetypes.init()
    for qywps_format in FORMATS:
        mimetypes.add_type(qywps_format.mime_type, qywps_format.extension, True)
...
class Format(object):
    ...
    Predefined Formats are stored in :class:`qywps.inout.formats.FORMATS`
...
def get_format(frmt, validator=None):
    """Return Format instance based on given qywps.inout.FORMATS keyword
    """
