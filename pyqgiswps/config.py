...
def load_configuration():
    ...
    CONFIG.set('metadata:ows', 'identification_abstract', 'Py-Qgis-WPS is an implementation of the Web Processing Service standard from the Open Geospatial Consortium.')
    ...
    CONFIG.set('metadata:oapi', 'description', 'Implementation of processes api standards from the Open Geospatial Consortium.')
